...
\subsection{Valuation of Contingent Claims}
  ...
  \begin{theorem}{Risk-Neural Valuation Principle}\label{the_risk_netural_valuation_principle_single_period}
...
\subsection{Valuation of Contingent Claims}
  ...
  \begin{proposition}{Risk-Neutral Valuation Principle\footnote{This is an extension of \texttt{Theorem \ref{sec_financial_terminology_and_single_period_model}.\ref{the_risk_netural_valuation_principle_single_period}} to the multi-period model.}}
  ...
  \begin{example}{}
    ...
    \[ V_1(\omega_1)=V_2(\omega_2)=\expect_\Q[X|S_1=9]=(2/3)\cdot5+(1/3)\cdot2=4 \]
    At time $t=1$ the contingent claim's value in states $\omega_3,\omega_4$ is
    \[ V_1(\omega_3)=V_2(\omega_4)=\expect_\Q[X|S_1=3]=(1/3)\cdot2+(2/3)\cdot0=2/3 \]
  \end{example}

  \begin{proposition}{}\label{prop_complete_model_and_martingale_measures}
