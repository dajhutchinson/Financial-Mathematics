...
\subsection{The Cox-Ross-Rubinstein Model}
  ...
  \begin{proposition}{Value of European Call Option in Cox-Ross-Rubinstein Model}
...
\subsection{The Cox-Ross-Rubinstein Model and the Black-Scholes Formula}
  ...
  \begin{theorem}{Black-Scholes Formula}
    ...
    \par Let $\Pi_K^{(t)}(0)$ denote its fair-price in a \textit{Cox-Ross-Rubinstein Model} with $T+1$ time-points $\left\{0,\frac{U}T,\dots,U\right\}$, constant interest rate $r_T=e^{-\frac{rU}T}-1$ and $u_T=e^{\igma\sqrt{U/T}}=\frac1{d_T}$. Then
